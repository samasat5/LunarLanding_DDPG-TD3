...
def train(
    ...
    plt.plot(qvalues, label="Raw Bias", color='tab:blue', alpha=0.3)  # transparent fluctuating curve
    plt.plot(np.arange(window-1, len(biases)), smooth_qvalue, label="Smoothed q_values", color='tab:blue', linewidth=2)
